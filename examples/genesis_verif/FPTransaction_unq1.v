...
//
// Random (_GENESIS2_INHERITANCE_PRIORITY_) = YES
//
// NamedTransCtrl (_GENESIS2_DECLARATION_PRIORITY_) = 
//
// SignIsPos_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 50
//
// Zero_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// Denorm100_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 2
//
// DenormFFF_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 2
//
// Denorm001_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 2
//
// DenormRnd_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 4
//
// QuietNaN_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// SignalingNaN_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// Min_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// Max_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// Inf_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// One_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// PointOneOneOne_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 10
//
// EzAndSml_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 0
//
// Random_DistWeight (_GENESIS2_DECLARATION_PRIORITY_) = 50
//

class FPTransaction_unq1;
...
*/
   ...
   static int 	SignIsPos_w = 50;
   static int 	Zero_w = 10;
   static int 	Denorm100_w = 2; 
   static int 	DenormFFF_w = 2; 
   static int 	Denorm001_w = 2;
   static int 	DenormRnd_w = 4;
   static int 	QuietNaN_w = 10; 
   static int 	SignalingNaN_w = 10; 
   static int 	Min_w = 10; 
   static int 	Max_w = 10; 
   static int 	Inf_w = 10; 
   static int 	One_w = 10; 
   static int 	PointOneOneOne_w = 10;
   static int 	EzAndSml_w =0;
   static int 	Random_w = 50;
   ...
   constraint pick_trans_type{
	...
	if (! AllWeightsInitialized) begin
	   if ($test$plusargs("SignIsPos_DistWeight")) begin
	      $value$plusargs("SignIsPos_DistWeight=%d",  SignIsPos_w);
	      $display("%t: FPTransaction_unq1: Runtime input +SignIsPos_DistWeight=%d found", $time, SignIsPos_w);
	   end
	   if ($test$plusargs("Zero_DistWeight")) begin
	      $value$plusargs("Zero_DistWeight=%d",  Zero_w);
	      $display("%t: FPTransaction_unq1: Runtime input +Zero_DistWeight=%d found", $time, Zero_w);
	   end
	   if ($test$plusargs("Denorm100_DistWeight")) begin
	      $value$plusargs("Denorm100_DistWeight=%d",  Denorm100_w);
	      $display("%t: FPTransaction_unq1: Runtime input +Denorm100_DistWeight=%d found", $time, Denorm100_w);
	   end
	   if ($test$plusargs("DenormFFF_DistWeight")) begin
	      $value$plusargs("DenormFFF_DistWeight=%d",  DenormFFF_w);
	      $display("%t: FPTransaction_unq1: Runtime input +DenormFFF_DistWeight=%d found", $time, DenormFFF_w);
	   end
	   if ($test$plusargs("Denorm001_DistWeight")) begin
	      $value$plusargs("Denorm001_DistWeight=%d",  Denorm001_w);
	      $display("%t: FPTransaction_unq1: Runtime input +Denorm001_DistWeight=%d found", $time, Denorm001_w);
	   end
	   if ($test$plusargs("DenormRnd_DistWeight")) begin
	      $value$plusargs("DenormRnd_DistWeight=%d",  DenormRnd_w);
	      $display("%t: FPTransaction_unq1: Runtime input +DenormRnd_DistWeight=%d found", $time, DenormRnd_w);
	   end
	   if ($test$plusargs("QuietNaN_DistWeight")) begin
	      $value$plusargs("QuietNaN_DistWeight=%d",  QuietNaN_w);
	      $display("%t: FPTransaction_unq1: Runtime input +QuietNaN_DistWeight=%d found", $time, QuietNaN_w);
	   end
	   if ($test$plusargs("SignalingNaN_DistWeight")) begin
	      $value$plusargs("SignalingNaN_DistWeight=%d",  SignalingNaN_w);
	      $display("%t: FPTransaction_unq1: Runtime input +SignalingNaN_DistWeight=%d found", $time, SignalingNaN_w);
	   end
	   if ($test$plusargs("Min_DistWeight")) begin
	      $value$plusargs("Min_DistWeight=%d",  Min_w);
	      $display("%t: FPTransaction_unq1: Runtime input +Min_DistWeight=%d found", $time, Min_w);
	   end
	   if ($test$plusargs("Max_DistWeight")) begin
	      $value$plusargs("Max_DistWeight=%d",  Max_w);
	      $display("%t: FPTransaction_unq1: Runtime input +Max_DistWeight=%d found", $time, Max_w);
	   end
	   if ($test$plusargs("Inf_DistWeight")) begin
	      $value$plusargs("Inf_DistWeight=%d",  Inf_w);
	      $display("%t: FPTransaction_unq1: Runtime input +Inf_DistWeight=%d found", $time, Inf_w);
	   end
	   if ($test$plusargs("One_DistWeight")) begin
	      $value$plusargs("One_DistWeight=%d",  One_w);
	      $display("%t: FPTransaction_unq1: Runtime input +One_DistWeight=%d found", $time, One_w);
	   end
	   if ($test$plusargs("PointOneOneOne_DistWeight")) begin
	      $value$plusargs("PointOneOneOne_DistWeight=%d",  PointOneOneOne_w);
	      $display("%t: FPTransaction_unq1: Runtime input +PointOneOneOne_DistWeight=%d found", $time, PointOneOneOne_w);
	   end
	   if ($test$plusargs("EzAndSml_DistWeight")) begin
	      $value$plusargs("EzAndSml_DistWeight=%d",  EzAndSml_w);
	      $display("%t: FPTransaction_unq1: Runtime input +EzAndSml_DistWeight=%d found", $time, EzAndSml_w);
	   end
	   if ($test$plusargs("Random_DistWeight")) begin
	      $value$plusargs("Random_DistWeight=%d",  Random_w);
	      $display("%t: FPTransaction_unq1: Runtime input +Random_DistWeight=%d found", $time, Random_w);
	   end
	end // if (! AllWeightsInitialized)
     endfunction // new
endclass : FPTransaction_unq1
