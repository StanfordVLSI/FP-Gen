...
#my @vts    = ( 'lvt' , 'svt' , 'hvt' );
my @vts    = ( 'svt' );
#my @delays = ( 0.3, 0.35, 0.4, 0.45 , 0.5 , 0.55 , 0.6 , 0.7 , 0.8, 0.9);  #for half precision
#my @delays = ( 0.45, 0.5 , 0.55 , 0.6, 0.65, 0.7 ,0.75, 0.8 , 0.9 , 1.0);  #for single precision
#my @delays = (  0.7 , 0.75 , 0.8 , 0.85, 0.9 , 0.95, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5 );  #for double
#my @delays = ( 0.95, 1.0, 1.05, 1.1, 1.15, 1.2, 1.25 );  #for quade
#my @delays = (  1.3, 1.4, 1.5, 1.6, 1.8,  1.7, 2.0, 2.2 );  #for quade
my @delays = ( 1.25, 1.3, 1.4, 1.45, 1.5, 1.55, 1.6, 1.65, 1.7, 1.8, 1.9, 2.0, 2.2 );  #for quade
#my @delays = ( 1.7, 1.9, 2.0, 2.2 );
#my @delays = ( 0.5 );
