...
$flow .= "legend(...\n";
foreach $filename(@csvs){
	my $filename_antiTex = $filename;
	$filename_antiTex =~ s/_/\\_/g;
        $flow .= "\t'$filename_antiTex - synthesized (no wires)',...\n";
        $flow .= "\t'$filename_antiTex - uninformed P&R',...\n";
        $flow .= "\t'$filename_antiTex - layout informed P&R',...\n";
}
foreach $filename(@designwares){
	my $filename_antiTex = $filename;
	$filename_antiTex =~ s/_/\\_/g;
